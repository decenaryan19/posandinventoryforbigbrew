                                    ...
                                    <h3 class="d-flex w-100 align-items-center">
                                        ...
                                        <div class="col-8">
                                            <select name="payment_type" id="payment_type" class="form-control rounded-0" required="required">
                                                ...
                                                <option value="2" <?= isset($payment_type) && $payment_type == 2 ? "selected" : "" ?>>G-Cash</option>
                                                <!-- <option value="3" <?= isset($payment_type) && $payment_type == 3 ? "selected" : "" ?>>Credit Card</option> -->
                                            </select>
                                        </div>
                                    </h3>
                                    <input type="text" id="payment_code" class="form-control form-control-sm rounded-0 d-none" name="payment_code" value="<?= isset($payment_code) ? $payment_code: "" ?>" placeholder="Gcash Number">
                                </div>
                            </div>
                        </div>
                    </form>
